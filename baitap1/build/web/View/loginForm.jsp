        ...
        <form action="taikhoan" method="POST">
            <div class="container">
                <div class="box-1">
                    ...
                    <button type="submit" class="btn btn-primary btn-uppercase btn-block">Đăng nhập</button>
                    <div class="registerPlease">
                        <center>
                            <div>
                                <p>Bạn chưa có tài khoản?</p>
                                <button type="submit" class="registernow" name="action" value="register">đăng ký</button>
                            </div>
                        </center>
                    </div>
                </div>
